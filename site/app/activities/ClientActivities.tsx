...
export function ClientActivities({
    ...
    return (
        <>
            <H1>Next Event</H1>
            <SectionWrapper>
                {nextEvent ? buildEvent(nextEvent) : (
                    <P>No upcoming events. Chat with us on <Link className="underline" href="https://discord.gg/pvz3PW69yw">Discord</Link> or <Link className="underline" href="/contact">contact us</Link> through our website!</P>
                )}
            </SectionWrapper>
            <Divider />
            <H1>Upcoming Activities</H1>
            {buildSection("upcoming-activities", filterActivities(upcomingActivities))}
            <Divider />
